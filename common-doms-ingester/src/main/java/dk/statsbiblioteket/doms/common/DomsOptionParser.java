...
public abstract class DomsOptionParser {
    ...
    protected static final Option REKLAME_TEMPLATE_OPTION
            = new Option("reklametemplate", true, "The pid of reklame template object");
    protected static final Option PBCORE_OPTION
            = new Option("pbcore", true, "The pbcore data for this object");
    protected static final Option REKLAME_METADATA_LOCATION_OPTION
            = new Option("reklamemetadata", true, "The reklamefilm metadata for this object");
    ...
    protected void parseMetadata(CommandLine cmd) throws OptionParseException, JAXBException {
        ...
        if (metadataLocation != null) {
            JAXBElement<BroadcastMetadata> ffprobeObject = (JAXBElement<BroadcastMetadata>) unmarshaller
