...
public class ReklameDomsIngesterTest {
    ...
    public void testIngest() throws Exception {
        ...
        Assert.assertEquals(1, webservice100.markInProgressObject.size());
        Assert.assertArrayEquals(
                new String[]{(String) webservice100.newObject.get(0)[3], (String) webservice100.newObject.get(1)[3]},
                ((List<String>) webservice100.markInProgressObject.get(0)[0]).toArray());
        ...
        Assert.assertEquals(1, webservice100.markPublishedObject.size());
        Assert.assertArrayEquals(
                new String[]{(String) webservice100.newObject.get(0)[3], (String) webservice100.newObject.get(1)[3]},
                ((List<String>) webservice100.markPublishedObject.get(0)[0]).toArray());
        ...
        Assert.assertEquals(1, webservice101.markInProgressObject.size());
        Assert.assertEquals(4, webservice101.modifyDatastream.size());
        Assert.assertEquals(1, webservice101.addRelation.size());
        Assert.assertEquals(1, webservice101.markPublishedObject.size());
