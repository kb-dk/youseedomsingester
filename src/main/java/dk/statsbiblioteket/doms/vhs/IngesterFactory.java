...
import dk.statsbiblioteket.doms.vhs.DomsIngester;
...
public class IngesterFactory {
    ...
    private static final String FEDORA_USERNAME_PROPERTY = "dk.statsbiblioteket.doms.vhs.fedorausername";
    private static final String FEDORA_PASSWORD_PROPERTY = "dk.statsbiblioteket.doms.vhs.fedorapassword";
    private static final String FEDORA_WEBSERVICE_URL_PROPERTY = "dk.statsbiblioteket.doms.vhs.fedorawebserviceurl";
