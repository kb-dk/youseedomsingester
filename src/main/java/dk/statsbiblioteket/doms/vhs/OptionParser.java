...
public class OptionParser {
     ...
     * loading content.
     */
    public dk.statsbiblioteket.doms.vhs.IngestContext parseOptions(String[] args) {
        ...
        dk.statsbiblioteket.doms.vhs.IngestContext context = new IngestContext(filename);
        ...
        try {
            ...
            context.setVHSMetadataContents(metadataContents);
        } catch (IOException e) {
            parseError(e.toString());
            return null;
        }
    ...
    private void printUsage() {
        ...
        usageFormatter.printHelp("vhsDomsIngester", options, true);
    }
