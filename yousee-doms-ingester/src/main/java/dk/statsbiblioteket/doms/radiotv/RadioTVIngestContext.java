...
public class RadioTVIngestContext implements IngestContext {
    ...
    private String ffprobeErrorContents;
    ...
    public String toString() {
        return "IngestContext{"
                ...
                + ", ffprobeErrorContents='" + ffprobeErrorContents + '\''
    ...
    public String getFfprobeErrorContents() {
        return ffprobeErrorContents;
    }

    public void setFfprobeErrorContents(String ffprobeErrorContents) {
        this.ffprobeErrorContents = ffprobeErrorContents;
    }
}
